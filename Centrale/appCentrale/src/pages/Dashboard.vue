      ...
      >
        ...
        >
          <template slot="content">
            ...
            <input @change="LoadTempDatas" type="date" id="start" name="trip-start"
                  v-model="TemperatureChart.dates.dateDebut"
                  value="2022-03-04"
                  min="2022-01-01" max="2022-12-31">

            <label for="start">Stop date:</label>
            <input @change="LoadTempDatas" type="date" id="stop" name="trip-stop"
            ...
            <div class="md-list-item-content ">
                ...
                <ul class="ChooseStation">
                  <li v-for="(station,index) in ChoosenStations" :key="index">
                    <md-checkbox v-model="tempStation" @change="LoadTempDatas" v-bind:value="station">{{station}}</md-checkbox>
                  </li>
                </ul>
              </div>
          </template>
      ...
      >
        ...
        >
          <template slot="content">
            ...
            <label for="start">Start date:</label>
            <input @change="LoadPressureDatas" type="date" id="start" name="trip-start"
                  v-model="PressureChart.dates.dateDebut"
                  value="2022-03-04"
                  min="2022-01-01" max="2022-12-31">

            <label for="start">Stop date:</label>
            <input @change="LoadPressureDatas" type="date" id="stop" name="trip-stop"
            ...
            <div class="md-list-item-content">
              ...
              <ul class="ChooseStation">
                <li v-for="(station,index) in ChoosenStations" :key="index">
                  <md-checkbox v-model="pressureStation" @change="LoadPressureDatas" v-bind:value="station">{{station}}</md-checkbox>
                </li>
              </ul>
              </div>
          </template>
      ...
      >
        ...
        >
          <template slot="content">
            ...
            <label for="start">Start date:</label>
            <input @change="LoadhygroDatas" type="date" id="start" name="trip-start"
                  v-model="hygroChart.dates.dateDebut"
                  value="2022-03-04"
                  min="2022-01-01" max="2022-12-31">

            <label for="start">Stop date:</label>
            <input @change="LoadhygroDatas" type="date" id="stop" name="trip-stop"
            ...
            <div class="md-list-item-content">
              ...
              <ul class="ChooseStation">
                <li v-for="(station,index) in ChoosenStations" :key="index">
                  <md-checkbox v-model="hygroStation" @change="LoadhygroDatas" v-bind:value="station">{{station}}</md-checkbox>
                </li>
              </ul>
              </div>
          </template>
      ...
      >
        ...
        >
          <template slot="content">
            ...
            <label for="start">Start date:</label>
            <input @change="LoadbrightDatas" type="date" id="start" name="trip-start"
                  v-model="brightChart.dates.dateDebut"
                  value="2022-03-04"
                  min="2022-01-01" max="2022-12-31">

            <label for="start">Stop date:</label>
            <input @change="LoadbrightDatas" type="date" id="stop" name="trip-stop"
            ...
            <div class="md-list-item-content">
              ...
              <ul class="ChooseStation">
                <li v-for="(station,index) in ChoosenStations" :key="index">
                  <md-checkbox v-model="brightStation" @change="LoadbrightDatas" v-bind:value="station">{{station}}</md-checkbox>
                </li>
              </ul>
              </div>
          </template>
      ...
      >
        ...
        >
          <template slot="content">
            ...
            <label for="start">Start date:</label>
            <input @change="LoadwindDatas" type="date" id="start" name="trip-start"
                  v-model="WindChart.dates.dateDebut"
                  value="2022-03-04"
                  min="2022-01-01" max="2022-12-31">

            <label for="start">Stop date:</label>
            <input @change="LoadwindDatas" type="date" id="stop" name="trip-stop"
            ...
            <div class="md-list-item-content">
              ...
              <ul class="ChooseStation">
                <li v-for="(station,index) in ChoosenStations" :key="index">
                  <md-checkbox v-model="windStation" @change="LoadwindDatas" v-bind:value="station">{{station}}</md-checkbox>
                </li>
              </ul>
              </div>
          </template>
  ...
  methods : {
    ...
    LoadPressureDatas(){
      ...
      this.pressureStation.forEach(station => {
        fetch("http://"+station+":8080/data/pressure/"+this.PressureChart.dates.dateDebut+","+this.PressureChart.dates.datefin)
        .then(response => response.json())
        .then(result => {
    ...
    LoadhygroDatas(){
      ...
      this.hygroStation.forEach(station => {
        fetch("http://"+station+":8080/data/hygrometry/"+this.hygroChart.dates.dateDebut+","+this.hygroChart.dates.datefin)
        .then(response => response.json())
        .then(result => {
    ...
    LoadbrightDatas(){
      ...
      this.brightStation.forEach(station => {
        fetch("http://"+station+":8080/data/brightness/"+this.brightChart.dates.dateDebut+","+this.brightChart.dates.datefin)
        .then(response => response.json())
        .then(result => {
    ...
    LoadwindDatas(){
      ...
      this.windStation.forEach(station => {
        fetch("http://"+station+":8080/data/windvelocity/"+this.WindChart.dates.dateDebut+","+this.WindChart.dates.datefin)
        .then(response => response.json())
        .then(result => {
